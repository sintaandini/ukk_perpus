                                    ...
                                    <div class="card-body">
                                        <?php
                                            ...
                                            $insert = mysqli_query($koneksi, "INSERT INTO user(nama,username,password,email,alamat,notelepon,level)     
                                             VALUES('$nama ','$username ','$password ','$email ','$alamat ','$notelepon ','$level')");
                                            if($insert){
                                        ...
                                        <form method= "post">
                                            ...
                                            <label class="small mb-1">No.Telepon</label>
                                                <input class="form-control" type="text" required name="notelepon" placeholder="Masukan No.Telepon" />
                                            </div>
                                            <br>
                                            <div class="form-group">
                                            ...
                                            <label class="small mb-1">Username</label>
                                                <input class="form-control" id="inputEmail" type="text" required name="username" placeholder="Masukan Username Anda" />
                                            </div>
                                            <br>
                                            
                                            <div class="form-group">
                                                <label class="small mb-1">password</label>
                                                <input class="form-control" id="inputpasword" required name="password" placeholder="Masukan Password Anda" />
                                            </div>
                                            <br>
                                            <div class="form-group>"
